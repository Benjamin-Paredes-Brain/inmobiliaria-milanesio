        ...
        <>
            ...
            <div className="servicios_container">
                ...
                <div className="servicios_content">
                    ...
                    <img className="servicios_content_img" src="/alquiler.jpg" alt="alquiler inmobiliario" />
                </div>

                <div className="servicios_content">
                <img className="servicios_content_img" src="/venta.jpg" alt="venta inmobiliaria" />
                    <div className="servicios_info">
                ...
                <div className="servicios_content">
                    ...
                    <img className="servicios_content_img" src="/tasacion.jpg" alt="tasacion inmobiliaria" />
                </div>

                <div className="servicios_content">
                <img className="servicios_content_img" src="/contrato.jpg" alt="contrato inmobiliario" />
                    <div className="servicios_info">
